...
## 快速入门
* [JindoFSx 存储加速/扩展系统快速入门](jindofsx_quickstart.md)

## 集群部署
* [快速部署一个简单的 JindoFSx 存储加速/扩展系统](deploy/deploy_jindofsx.md)
* [部署高可用 JindoFSx 存储加速/扩展系统](deploy/deploy_jindofsx_ha.md)
* [基于 Prometheus + Grafana 搭建 JindoFSx 存储加速/扩展系统可视化指标观测平台](jindofsx_metrics.md)
