...
请参考 [使用 JindoTable 将 Hive 表和分区数据迁移到阿里云 OSS-HDFS 服务](/docs/user/4.x/4.3.0/jindofs/jindotable/table_moveto.md)

#### archiveTable/unarchiveTable 命令

暂不支持阿里云 OSS-HDFS 服务，对于 OSS 服务，请参考 [JindoTable 归档和解冻 OSS 上的表或分区](/docs/user/4.x/4.3.0/oss/jindotable/jindotable_archive.md)
