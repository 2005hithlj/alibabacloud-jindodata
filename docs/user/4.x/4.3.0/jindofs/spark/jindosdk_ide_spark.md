...
```xml
        ...
        <dependency>
            ...
            <scope>system</scope>
            <systemPath>/Users/xx/xx/jindosdk-4.3.0.jar</systemPath>
        </dependency>
        <dependency>
            <groupId>com.aliyun.jindodata</groupId>
            ...
            <version>4.3.0</version>
            <scope>system</scope>
            <systemPath>/Users/xx/xx/jindo-core-4.3.0.jar</systemPath>
        </dependency>
```
然后您可以编写Java程序使用SDK
```java
...
public class TestJindoSDK {
  public static void main(String[] args) throws Exception {
    SparkSession spark = SparkSession
        ...
        .config("spark.hadoop.fs.oss.impl", "com.aliyun.jindodata.oss.OSS")
